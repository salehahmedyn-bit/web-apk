...
import com.webtoapp.ui.screens.CreateGalleryAppScreen
    ...
    NavHost(
        ...
        composable(Routes.HOME) {
            HomeScreen(
                ...
                onCreateGalleryApp = {
                    navController.navigate(Routes.CREATE_GALLERY_APP)
                },
                onCreateHtmlApp = {
                ...
                onEditAppCore = { webApp ->
                    ...
                    when (webApp.appType) {
                        ...
                        com.webtoapp.data.model.AppType.VIDEO -> {
                            navController.navigate(Routes.editMediaApp(webApp.id))
                        }
                        com.webtoapp.data.model.AppType.GALLERY -> {
                            navController.navigate(Routes.editGalleryApp(webApp.id))
                        }
                        com.webtoapp.data.model.AppType.HTML -> {
                            navController.navigate(Routes.editHtmlApp(webApp.id))
                        }
                        com.webtoapp.data.model.AppType.FRONTEND -> {
                            navController.navigate(Routes.editFrontendApp(webApp.id))
                        }
                    }
                },
                onPreviewApp = { webApp ->
                ...
                onOpenBrowserKernel = {
                    navController.navigate(Routes.BROWSER_KERNEL)
                },
                onOpenHostsAdBlock = {
                    navController.navigate(Routes.HOSTS_ADBLOCK)
                },
