...
object Strings {
    ...
    val saveFailed: String get() = when (lang) {
        AppLanguage.CHINESE -> "Save failed"
    ...
    val webViewAdvancedConfig: String get() = when (lang) {
        AppLanguage.CHINESE -> "WebView 配置"
        AppLanguage.ENGLISH -> "WebView Config"
        AppLanguage.ARABIC -> "إعدادات WebView"
    }
